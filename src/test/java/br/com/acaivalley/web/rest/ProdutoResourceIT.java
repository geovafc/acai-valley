package br.com.acaivalley.web.rest;

import static br.com.acaivalley.web.rest.TestUtil.sameNumber;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import br.com.acaivalley.IntegrationTest;
import br.com.acaivalley.domain.Produto;
import br.com.acaivalley.repository.ProdutoRepository;
import br.com.acaivalley.service.dto.ProdutoDTO;
import br.com.acaivalley.service.mapper.ProdutoMapper;
...
class ProdutoResourceIT {
    ...
    public static Produto createEntity(EntityManager em) {
        Produto produto = new Produto().nome(DEFAULT_NOME).valor(DEFAULT_VALOR).descricao(DEFAULT_DESCRICAO);
        return produto;
    }
    ...
    public static Produto createUpdatedEntity(EntityManager em) {
        Produto produto = new Produto().nome(UPDATED_NOME).valor(UPDATED_VALOR).descricao(UPDATED_DESCRICAO);
        return produto;
    }
    ...
    void createProduto() throws Exception {
        ...
        assertThat(testProduto.getValor()).isEqualByComparingTo(DEFAULT_VALOR);
    ...
    void putNewProduto() throws Exception {
        ...
        updatedProduto.nome(UPDATED_NOME).valor(UPDATED_VALOR).descricao(UPDATED_DESCRICAO);
    ...
    void partialUpdateProdutoWithPatch() throws Exception {
        ...
        partialUpdatedProduto.valor(UPDATED_VALOR);
        ...
        Produto testProduto = produtoList.get(produtoList.size() - 1);
        assertThat(testProduto.getNome()).isEqualTo(DEFAULT_NOME);
        assertThat(testProduto.getValor()).isEqualByComparingTo(UPDATED_VALOR);
        assertThat(testProduto.getDescricao()).isEqualTo(DEFAULT_DESCRICAO);
    }
    ...
    void fullUpdateProdutoWithPatch() throws Exception {
        ...
        partialUpdatedProduto.nome(UPDATED_NOME).valor(UPDATED_VALOR).descricao(UPDATED_DESCRICAO);
